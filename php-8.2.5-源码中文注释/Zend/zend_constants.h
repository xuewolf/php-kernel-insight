...
// ing4, 获取附加标记，后8位是flag
#define ZEND_CONSTANT_FLAGS(c) \
	(Z_CONSTANT_FLAGS((c)->value) & 0xff)

// ing4, 取得常量所属模块的编号，前24位
#define ZEND_CONSTANT_MODULE_NUMBER(c) \
	(Z_CONSTANT_FLAGS((c)->value) >> 8)
	
// ing4, 写入 constant_flags ，p1:常量，p2:_flags，p3:模块编号
// constant_flags 中 flags占后8位，_module_number 占前24位。
...
// ing4, 获取特殊常量，true,false,null 三个
