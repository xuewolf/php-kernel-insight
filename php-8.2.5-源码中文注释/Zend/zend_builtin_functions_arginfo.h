...
// ing3, arginfo_zend_version 方法：不可引用返回，0个必要参数，返回类型 string，不允null
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_zend_version, 0, 0, IS_STRING, 0)
ZEND_END_ARG_INFO()

// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_func_num_args 方法：不可引用返回，0个必要参数，返回类型 整数，不允null
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_func_num_args, 0, 0, IS_LONG, 0)
ZEND_END_ARG_INFO()

// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_func_get_arg 方法：不可引用返回，1个必要参数，返回类型 mixed，不允null
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_func_get_arg, 0, 1, IS_MIXED, 0)
	// ing3, 无默认值的 参数信息：不可引用传递，参数名称，类型，是否允null
	ZEND_ARG_TYPE_INFO(0, position, IS_LONG, 0)
ZEND_END_ARG_INFO()

// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_func_get_args 方法：不可引用返回，0个必要参数，返回类型 array，不允null
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_func_get_args, 0, 0, IS_ARRAY, 0)
ZEND_END_ARG_INFO()

// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_strlen 方法：不可引用返回，1个必要参数，返回类型 整数，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_strcmp 方法：不可引用返回，2个必要参数，返回类型 整数，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_strncmp 方法：不可引用返回，3个必要参数，返回类型 整数，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_error_reporting 方法：不可引用返回，0个必要参数，返回类型 整数，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_define 方法：不可引用返回，2个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_defined 方法：不可引用返回，1个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_get_class 方法：不可引用返回，0个必要参数，返回类型 mixed，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_is_subclass_of 方法：不可引用返回，2个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_is_a 方法：不可引用返回，2个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_get_class_vars 方法：不可引用返回，1个必要参数，返回类型 array，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_get_object_vars 方法：不可引用返回，1个必要参数，返回类型 array，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_get_class_methods 方法：不可引用返回，1个必要参数，返回类型 array，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_method_exists 方法：不可引用返回，2个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, offsetGet 方法：不可引用返回，2个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_class_exists 方法：不可引用返回，1个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_interface_exists 方法：不可引用返回，1个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_trait_exists 方法：不可引用返回，1个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_enum_exists 方法：不可引用返回，1个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_function_exists 方法：不可引用返回，1个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_class_alias 方法：不可引用返回，2个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_trigger_error 方法：不可引用返回，1个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_restore_error_handler 方法：不可引用返回，0个必要参数，返回类型 true，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_get_defined_functions 方法：不可引用返回，0个必要参数，返回类型 array，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_get_resource_type 方法：不可引用返回，1个必要参数，返回类型 string，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_get_resource_id 方法：不可引用返回，1个必要参数，返回类型 整数，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_get_resources 方法：不可引用返回，0个必要参数，返回类型 array，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_get_loaded_extensions 方法：不可引用返回，0个必要参数，返回类型 array，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_get_defined_constants 方法：不可引用返回，0个必要参数，返回类型 array，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_debug_backtrace 方法：不可引用返回，0个必要参数，返回类型 array，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_debug_print_backtrace 方法：不可引用返回，0个必要参数，返回类型 void，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_extension_loaded 方法：不可引用返回，1个必要参数，返回类型 bool，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_zend_thread_id 方法：不可引用返回，0个必要参数，返回类型 mixed，不允null
...
// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_gc_enabled 方法：不可引用返回，0个必要参数，返回类型 mixed，不允null
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_gc_enabled, 0, 0, _IS_BOOL, 0)
ZEND_END_ARG_INFO()

// 创建 参数信息列表 ，增加第一个 返回类型不允null 的 参数（返回值）。
// 传入：变量名，是否引用返回，必要的参数数，类型，是否允null
// ing3, arginfo_gc_enable 方法：不可引用返回，0个必要参数，返回类型 mixed，不允null
...
// 调试模式并线程安全时，添加 zend_thread_id 函数 
#if ZEND_DEBUG && defined(ZTS)
...
// ing3, 原生入口，这个是用来创建 _zend_function_entry 实例的，就是 函数或成员方法。第四个是参数数量 ，可以通过计算得到
...
// #define ZEND_SUPPORTS_COMPILE_TIME_EVAL_FE(name, arg_info) ZEND_RAW_FENTRY(#name, zif_##name, arg_info, 

// ing3, 把上面声名的各函数 组装成 zend_function
static const zend_function_entry ext_functions[] = {
	// 每个zend_function 有5个元素：【函数名 ，对内的内置函数名，参数信息表指针，参数数量，flags】
	// { zend_name, name, arg_info, (uint32_t) (sizeof(arg_info)/sizeof(struct _zend_internal_arg_info)-1), 0 }
...
static zend_class_entry *register_class_stdClass(void)
{
	...
	// 创建修饰属性名 AllowDynamicProperties，1个参数（后面没添加参数）
